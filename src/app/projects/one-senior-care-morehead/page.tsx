...
const dronePhotos = Array.from({ length: 16 }, (_, i) => ({
  src: `/projects/morehead/drone-${String(i + 1).padStart(2, "0")}.jpg`,
  width: 1200,
  height: 800,
  alt: `One Senior Care Morehead — drone view ${i + 1}`,
}))
...
const progressPhotos = [
  ...
  src: `/projects/morehead/progress-${String(n).padStart(2, "0")}.jpg`,
  width: 1200,
  height: 900,
  alt: `One Senior Care Morehead — construction progress ${n}`,
}))
