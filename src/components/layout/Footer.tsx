    ...
    <footer style={{ background: "var(--footer-bg)", color: "var(--footer-fg)" }}>
      <div className="mx-auto max-w-[1480px] px-6 md:px-12 py-16 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed" style={{ color: "rgba(207,205,199,0.7)" }}>
        ...
        {/* Links */}
        <div>
          <p className="text-xs uppercase tracking-[0.18em] mb-4" style={{ color: "var(--muted)" }}>
            Pages
          </p>
      ...
      <div
        ...
        style={{ borderColor: "rgba(207,205,199,0.12)", color: "rgba(207,205,199,0.45)" }}
      >
